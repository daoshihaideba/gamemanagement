...
let BULLET_MOVE_TIME = 1000;
let BULLET_MOVE_SPEED = 1000;
cc.Class({
    ...
    emit: function (cannonPos, mathRote, targetFish) {
        ...
        if (this.targetFish){
            ...
            this.node.runAction(cc.moveBy(BULLET_MOVE_TIME/BULLET_MOVE_SPEED, moveBy));
        }
    },
    ...
    updateDir: function (dt) {
        if (!!this.targetFish && !!this.targetFish.node  && !this.targetFish.isDestroyed){
