...
cc.Class({
    ...
    start () {
        ...
        this.BigFishAnima.active = false;
        this.BigFishAnima.getComponent(dragonBones.ArmatureDisplay).addEventListener(dragonBones.EventObject.COMPLETE, function (event) {
            this.BigFishAnima.active = false;
        }, this);
    },
    ...
    startBigFishAnima:function(changeCount){
        this.BigFishAnima.active = true;
        let armature = this.BigFishAnima.getComponent(dragonBones.ArmatureDisplay).armature();
        armature.animation.stop();
        this.BigFishAnima.getComponent(dragonBones.ArmatureDisplay).playAnimation("action",1);
        this.BigFishAnima.getChildByName("change").getComponent("cc.Label").string = changeCount;
    },
