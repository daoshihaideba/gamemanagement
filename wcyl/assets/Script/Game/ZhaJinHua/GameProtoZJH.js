...
// 操作时间
proto.OPERATION_TIME = 115;// 扎金花协议
//-----------------------------玩家操作----------------------------------------
...
proto.chairTurnPush = function (chairId, currentStakeLevel, canCompare) {
    return {
...
proto.userStakePush = function (chairId, stakeLevel, multiple, goldSumAmount, round) {
    return {
