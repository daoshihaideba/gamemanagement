...
module.exports = function (app, http) {
    ...
    http.post('/getGameControllerData', function (req, res) {
        ...
        rpcAPI.rpc('robot.controllerRemote.getGameControllerData', 'robot', parseInt(req.body.kind),parseInt(req.body.level), function (err, data) {
            if (!!err){
                res.send({code: err});
            }else{
    ...
    http.post('/updateGameControllerData', function(req, res) {
        ...
        rpcAPI.rpc('robot.controllerRemote.updateGameControllerData', 'robot', parseInt(req.body.kind), parseInt(req.body.level), data, function (err) {
    ...
    http.post('/modifyInventoryValue', function (req, res) {
        ...
        rpcAPI.rpc('robot.controllerRemote.modifyInventoryValue', 'robot', req.body.uid, parseInt(req.body.kind), parseFloat(req.body.count), parseFloat(req.body.level), function (err) {
            res.send({code: !!err?err:code.OK});
        })
    })
};