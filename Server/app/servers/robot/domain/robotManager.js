...
exp.scheduleTaskRobotMatch = function () {
    ...
    for (let i = 0; i < gameTypes.length; ++i){
        ...
        let controllerData = controllerManager.getGameControllerData(gameTypeInfo.kind,gameTypeInfo.level);
...
exp.startRoom = function (gameTypeInfo, cb) {
    ...
    async.series([
        ...
        function (cb) {
            ...
            exp.matchRoom(robotInfo, roomArr, gameTypeInfo, function (err) {
                if (!!err){
...
exp.requestRobotNotify = function (roomID, gameTypeInfo, count, cb) {
    let gameControlData = controllerManager.getGameControllerData(gameTypeInfo.kind,gameTypeInfo.level);
