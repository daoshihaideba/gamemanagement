...
exp.gameCaptureNotify = function (fishID,rangeFish) {
    return {
...
exp.gameCapturePush = function (chairID, fishIDArr, gainGoldArr, curWinGold,prizeMUL) {
    return {
...
exp.gameRobotCaptureNotify = function (chairID, fishID,rangeFish) {
    return {
