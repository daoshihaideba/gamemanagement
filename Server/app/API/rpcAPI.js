...
exp.getCurRobotWinRate = function (kind,level, cb) {
    pomelo.app.rpc.robot.controllerRemote.getCurRobotWinRate.toServer("robot", kind,level, cb);
};

exp.robotGoldChanged = function (kind, count,level, cb) {
    pomelo.app.rpc.robot.controllerRemote.robotGoldChanged.toServer("robot", kind, count,level, cb);
};